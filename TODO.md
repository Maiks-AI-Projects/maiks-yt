...
- [ ] Send warning messages to originating platform chat.
  ...
  - 2026-07-10 added a read-only provider action readiness matrix to `/admin/connections`: Discord/Twitch/YouTube warning sends are listed as fail-closed, while provider-side delete/hide, timeout, and ban remain gated with visible reasons.
...
- [ ] Moderation gate: approve rules, actions, audit log, appeal/review expectations, and streamer override before enforcement.
  - 2026-07-10 Phase B1 adds moderation-window disabled-action explanations for missing rights and provider-write gates. Real provider enforcement, automatic warnings, durable allow rules, and policy/strike schema remain gated.
