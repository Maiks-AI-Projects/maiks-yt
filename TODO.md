...
- [ ] Redesign the linked public schedule, projects, updates, links, games, rules, and privacy pages one at a time.
  ...
  - [ ] Make the remaining `API_PUBLIC_BASE_URL` fallbacks environment-aware in account image URLs, domain identity, and API runtime construction; explicit configuration must keep precedence.
