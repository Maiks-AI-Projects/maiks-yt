...
- [x] Design game library, game suggestions, and play-schedule links.
  ...
  - 2026-07-10 added schedule-to-game linking runtime locally for review: owner-gated `/admin/schedule/:id/games`, a single-game focus editor in `/admin/schedule`, public `/schedule` game focus rendering for public linked games only, and no new migration/provider sync/money behavior.
