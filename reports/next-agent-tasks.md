...
- Phase C1 money planning is captured in `reports/money-accounting-stage-plan.md`. Phase C2 generated migration `0023_slimy_harpoon.sql` for private ledger/rules/reports. After coordinator review and dev application, the next money task should build owner-only manual money entry/list/report foundations, not public payment behavior.
