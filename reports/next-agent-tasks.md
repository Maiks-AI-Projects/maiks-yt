...
- Phase 6G visibility: owner-gated `GET /admin/connections/intake` and the `/admin/connections` Recent Received Events panel show recent intake ledger rows with redacted payload previews only. This is read-only and has no mutation controls.
