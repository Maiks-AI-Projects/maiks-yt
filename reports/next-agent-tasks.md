...
- Phase 6G next: broad non-chat provider intake for EventSub/Gateway/webhook surfaces. Start with read-only registration/logging of selected low-risk events and unknown-safe fallback rows; do not add provider writes, public routing, money settlement, moderation enforcement, or production behavior.
