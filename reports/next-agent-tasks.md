...
- Phase 6G next: add YouTube activity/pubsub surfaces. Start with read-only registration/logging and unknown-safe fallback rows; do not add provider writes, public routing, money settlement, moderation enforcement, or production behavior.
