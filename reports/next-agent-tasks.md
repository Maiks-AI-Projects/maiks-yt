...
- Phase C1 money planning is captured in `reports/money-accounting-stage-plan.md`. Phase C2 generated/applied migration `0023_slimy_harpoon.sql` for private ledger/rules/reports on dev. Phase C3 adds owner-only `/admin/money` manual entry/list foundations. Next money task should improve corrections, receipt references, warnings, and CSV/report export, not public payment behavior.
