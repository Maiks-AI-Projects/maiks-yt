...
Coordinator deploy and dev smoke for Phase 5D fake/local moderation commands and audit, then choose the next follow-up such as creator/content utilities, durable moderation audit design, or another bounded feature lane.
...
3. Phase 5D fake/local moderation commands are locally reviewed and ready for coordinator deploy/dev smoke; durable moderation audit and real provider enforcement remain separate future gates.
