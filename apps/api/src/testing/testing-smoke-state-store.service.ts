...
import type { TestingSmokeStateActor, TestingSmokeStateRepository } from "./testing-smoke-state.types.js";
...
const resolveActor = async (
  ...
  authUserId: string
): Promise<TestingSmokeStateActor | null> => {
...
export const createTestingSmokeStateRepository = (
  pool: QueryExecutor
