...
import type { BackupHealthActor, BackupHealthRepository } from "./backup-health.types.js";
...
const resolveActor = async (
  ...
  authUserId: string
): Promise<BackupHealthActor | null> => {
...
export const createBackupHealthRepository = (
  pool: QueryExecutor
